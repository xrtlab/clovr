...
[ExecuteInEditMode]
    public class OVRT_RenderModel : MonoBehaviour
    {
        ...
        private bool LoadComponents(RenderModelInterfaceHolder holder, string renderModelName)
        {
            ...
            var t = transform;
            // Normally this would be a good idea but extremely annoying to see own models and scripts get disabled by this annoying call
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                catch (System.Exception e)
                {
                    ...
                    {
                        //Pass, this is an unfixable problem for now.
                    }
                    else
                    {
                        Debug.LogError(e);
